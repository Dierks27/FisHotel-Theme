  ...
  window.FISHOTEL_QT_METHODS = {
    ...
    methods: [
       ...
       * ------------------------------------------------------------------ */
      {
        ...
        indication_summary: 'Covers ich, velvet, brook. Aggressive variant also covers Uronema. Variants drive dose math (no copper ramp). 14-day therapeutic + transfer + 14-day clean observation.',
        duration_badge: '29D',
        is_default_recommendation: false,
        not_reef_safe: true,
