...
define( 'FISHOTEL_THEME_VERSION', '1.18.14' );
...
// Shipping settings helper (reads Batch Plugin options). Loaded first so the
// self-serve module below can call into it.
require_once FISHOTEL_THEME_DIR . '/inc/customer/shipping-days-helper.php';
