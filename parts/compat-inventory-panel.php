...
<section class="fh-compat-inventory" data-fh-inventory-panel aria-labelledby="fh-compat-inventory-title">
	<header class="fh-compat-inventory__head">
		<div class="fh-compat-inventory__head-top">
			<div class="fh-compat-inventory__head-text">
			...
			<label class="fh-compat-inventory__toggle">
				<input type="checkbox" data-fh-inventory-include-w>
				<span>Include &ldquo;Caution&rdquo; matches</span>
			</label>
		</div>
		<p class="fh-compat-inventory__hint"><em>Tap a fish to view it &middot; Tap + Add to put it on your Considering list.</em></p>
	</header>
