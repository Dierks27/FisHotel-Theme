...
<div style="max-width:var(--fh-max-width); margin:0 auto; padding:48px var(--fh-page-pad);">
    <?php if(have_posts()): ?>
    <div class="fh-product-grid"><?php while(have_posts()):the_post(); ?><a href="<?php the_permalink(); ?>" class="fh-fish-card"><div class="fh-fish-card__image"><?php fishotel_product_thumbnail( get_the_ID(), 'fishotel-product-card' ); ?></div><div class="fh-fish-card__body"><div class="fh-fish-card__name"><?php the_title(); ?></div></div></a><?php endwhile; ?></div>
